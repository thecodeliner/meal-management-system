                    ...
                    <form>
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="email" class="w-full p-2 border border-gray-300 rounded-md" value="{{ $users->name }}">
                            </div>
                            <div>
                            ...
                            <div class="md:col-span-2">
                                ...
                                <input type="tel" class="w-full p-2 border border-gray-300 rounded-md" value="{{ $users->room_no}}">
                            </div>
                        </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-lg shadow p-4">
                    <div class="flex flex-col items-center">
                        ...
                        <p class="text-gray-600 text-sm">{{ $users->role}}</p>
                        <p class="text-gray-600 text-sm">{{ $users->email}}</p>
                        <p class="text-gray-500 text-xs mt-2">{{ $users->created_at->format('d:m:Y')}}</p>
                    </div>
                </div>
